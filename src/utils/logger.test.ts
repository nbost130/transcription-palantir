...
import { logger, logJobStart, logJobComplete, logJobError, logApiRequest, logWorkerStart, logWorkerStop, logQueueEvent, logFileWatcherEvent, logError, logFatalError, createTimer } from './logger';
